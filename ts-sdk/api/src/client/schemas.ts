...
export const LpPositionLimitOrderSwapSchema = z.enum(
  Object.values(LpPositionLimitOrderSwap) as [string, ...string[]]
);
export const LpPositionAutoCompoundSchema = z.enum(
  Object.values(LpPositionAutoCompound) as [string, ...string[]]
);
export const LpPositionRebalanceSchema = z.enum(
  Object.values(LpPositionRebalance)  as [string, ...string[]]
);
export const LpPositionsActionTypeSchema = z.enum(
  Object.values(LpPositionsActionType)  as [string, ...string[]]
);
...
export const TunaLpPosition = z.object({
  ...
  state: z
    .string()
    .transform(v => (v === "normal" ? "open" : v))
    .pipe(TunaPositionStateSchema) as unknown as typeof TunaPositionStateSchema,
  lowerPrice: z.number(),
  upperPrice: z.number(),
  ...
  marketMaker: z
    ...
    .pipe(PoolProviderSchema) as unknown as typeof PoolProviderSchema,
  openedAt: z.coerce.date(),
...
// export const TunaLpPositionAction = z.discriminatedUnion("action", [
//   z.object({
//     action: z.literal(LpPositionsActionType.OPEN_POSITION),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionOpen,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.CLOSE_POSITION),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionClose,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.INCREASE_LIQUIDITY),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionIncreaseLiquidity,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.DECREASE_LIQUIDITY),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionDecreaseLiquidity,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.REPAY_DEBT),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionRepayDebt,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.LIQUIDATE),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionLiquidate,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.EXECUTE_LIMIT_ORDER),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionLiquidate,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.COLLECT_FEES),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionCollectFees,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.COLLECT_REWARDS),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.COLLECT_AND_COMPOUND_FEES),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionCollectAndCompoundFees,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.REBALANCE_POSITION),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.SET_LIMIT_ORDERS),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionParametersUpdate,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.SET_FLAGS),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionParametersUpdate,
//   }),
//   z.object({
//     action: z.literal(LpPositionsActionType.SET_REBALANCE_THRESHOLD),
//     txSignature: z.string(),
//     txTimestamp: z.coerce.date(),
//     data: TunaLpPositionActionParametersUpdate,
//   }),
